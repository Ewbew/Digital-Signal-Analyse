...
figure
spectrogram(x, rectwin(500), 0, 500, fs, 'yaxis') % WINDOW = rectwin(500), NOVERLAP = 0, NFFT = 500 (no zero-padding), Fs = 20000
...
soundsc(x, fs)
figure
spectrogram(x, hamming(100), 0, 100, fs, 'yaxis')
...
xnoisy = x + e;
figure
spectrogram(xnoisy, hamming(100), 0, 100, fs, 'yaxis')
